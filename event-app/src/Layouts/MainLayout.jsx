...
import { fetchEvents } from "../reducer/calendarSlice";
	...
	return (
		<div>
			<div className="container mx-auto max-w-[1490px] h-screen w-full px-20 py-10">
				<div className="flex gap-8 items-start h-full w-full overflow-hidden rounded-4xl px-6 py-5 shadow-[0_1px_20px_rgba(0,0,0,0.1)]">
